...
```js
import ecc from 'plasmajs-ecc'
// or
const ecc = require('plasmajs-ecc')
```

# Include

-   Install with: `npm install @plasma/plasmajs-ecc`
...
-   `wif` **[wif](#wif)**
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** public key prefix (optional, default `'plasma'`)
...
-   `pubkey` **[pubkey](#pubkey)** like plasmaKey..
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)**  (optional, default `'plasma'`)
...
-   `signature` **([String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String) \| [Buffer](https://nodejs.org/api/buffer.html))** (plasmabase58sig.., Hex, Buffer)
...
```js
let {PrivateKey, PublicKey, Signature, Aes, key_utils, config} = require('plasmajs-ecc')
...
```bash
git clone https://github.com/plasmadlt/plasmajs-ecc
cd plasmajs-ecc
npm install
npm run build_browser
# builds: ./lib/plasmajs-ecc.js
# Verify release hash
```

```html
<script src=plasmajs-ecc.js></script>
```

```js
var ecc = plasmajs_ecc
