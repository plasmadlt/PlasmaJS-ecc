...
*/
function PublicKey(Q, pubkey_prefix = 'PLASMA') {
    if(typeof Q === 'string') {
    ...
    */
    function toString(pubkey_prefix = 'PLASMA') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'PLASMA']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'PLASMA') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'PLASMA') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'PLASMA') {
